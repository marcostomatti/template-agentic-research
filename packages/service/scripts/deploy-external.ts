 ...
 * n8n CLI and so wants the container this one does without. Its steps
 * that drive that CLI have landed. `audit-workflows.ts` sits on this
 * side of the same line and has landed whole, its own command line
 * included.
 *
 ...
 * Arming a LOCAL instance is `activate-workflows.sh`, whose
 * seed-and-publish steps have landed.
 *
 ...
 * which has landed, command line and all.
 *
