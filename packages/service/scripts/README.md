...
What is still deferred is the two rows above that carry no `landed`
...
already. Both are q16b's, whose docs-completion remainder landed
`check-doc-links.ts` first.
