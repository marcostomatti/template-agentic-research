...
| `verify-external.sh` reaches no request or statement that changes the deployment it reads | `tests/invariants/verify-external-readonly.test.ts` | q16b | Not enforced |
