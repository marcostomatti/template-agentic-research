...
| The scratch stack shares no container name, published port or volume with the dev stack and its Postgres listens on the port it publishes | `tests/invariants/scratch-stack.test.ts` | q16b | Not enforced |
