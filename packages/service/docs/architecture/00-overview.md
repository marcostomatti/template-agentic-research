...
| `src/sources/` | The source adapter contract, the adapters that satisfy it (phase 4 onward, push capture included), and the pure text reductions those adapters share — which front no source and are registered nowhere. |
