...
import type { LoggerOptions, TypedClient } from '../service-core/index.js';
 ...
 * - `logger` — optional `LoggerOptions` forwarded to `lib/logger`; sensible defaults applied when omitted
 */
