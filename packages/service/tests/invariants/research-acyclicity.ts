 ...
 * because an anti-join over this schema nests: the guard in either
 * raise statement carries a `SELECT` whose own predicate is
 * parenthesised, and the first `)` closes that instead.
 *
