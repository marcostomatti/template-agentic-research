 ...
 * inside a `NOT EXISTS`. The built tree carries three anti-joins and
 * none of them is over that table — two guard a raise against
 * `research_pool` and the third reads a CTE — so the span walk runs
