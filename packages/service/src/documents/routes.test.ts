 ...
 *
 * NINE CASES IN EIGHT GROUPS. Two guard the fixture and the
 ...
 * vocabulary. The ninth reads no response at all: the binding
...
import { buildDocumentsRouter, documentsRouteSchemas } from './routes.js';
...
describe('the request bindings this module exports', () => {
  it('keys its table by exactly the labels the router declares', () => {
    ...
    const bound = Object.keys(documentsRouteSchemas).sort();
    ...
    // call.
    expect(bound).toContain('GET /domains/:slug/documents');
