...
ts-symbols refs <file>:<line>:<col>  # Symbol tracing (also outline|def|type) — beats grep for overloaded/re-exported names; see ~/.claude/skills/ts-symbols-for-agents/SKILL.md
