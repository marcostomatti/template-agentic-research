...
| `packages/dev-tools` | `@ar/dev-tools` | Development tools shell and Vite plugin (private devDependency of `@ar/web`). Multi-entry library: main shell, feedback UI (phase 2), Vite plugin. Layered architecture: core layer imports no node builtins; features and Vite plugin build on core.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
