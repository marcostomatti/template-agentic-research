...
| Review of a TypeScript change | `typescript-reviewer` | `.claude/agents/typescript-reviewer.md` |
...
machine happens to hold — or against nothing. The seven tracked rows
